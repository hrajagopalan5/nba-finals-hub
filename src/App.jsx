...
const SCHEDULE = [
  ...
  {game:3,date:"Mon, Jun 8", time:"8:30 PM ET",home:"NYK",away:"SAS",status:"final",  network:"ABC"},
  {game:4,date:"Wed, Jun 10",time:"8:30 PM ET",home:"NYK",away:"SAS",status:"final",  network:"ABC"},
  {game:5,date:"Sat, Jun 13",time:"8:30 PM ET",home:"SAS",away:"NYK",status:"next",network:"ABC"},
...
const NYK_PLAYERS = [
  { name:"Jalen Brunson",    pos:"PG",jersey:11,
    ...
    log:[
      ...
      {opp:"SAS",g:3,res:"L",pts:26,reb:4,ast:7,stl:1,blk:0,fgm:10,fga:22,tpm:2,tpa:6,min:40},
      {opp:"SAS",g:4,res:"W",pts:24,reb:3,ast:8,stl:1,blk:0,fgm:9,fga:21,tpm:2,tpa:7,min:41},
    ]},
  { name:"Karl-A. Towns",   pos:"C",jersey:32,
    ...
    log:[
      ...
      {opp:"SAS",g:3,res:"L",pts:24,reb:11,ast:2,stl:0,blk:1,fgm:9,fga:17,tpm:2,tpa:5,min:38},
      {opp:"SAS",g:4,res:"W",pts:14,reb:11,ast:2,stl:0,blk:1,fgm:5,fga:11,tpm:1,tpa:3,min:26},
    ]},
  { name:"OG Anunoby",     pos:"SF",jersey:8,
    ...
    log:[
      ...
      {opp:"SAS",g:3,res:"L",pts:16,reb:6,ast:2,stl:1,blk:1,fgm:6,fga:13,tpm:2,tpa:5,min:39},
      {opp:"SAS",g:4,res:"W",pts:19,reb:6,ast:2,stl:2,blk:1,fgm:7,fga:14,tpm:3,tpa:6,min:42},
    ]},
  { name:"Mikal Bridges",   pos:"SF",jersey:25,
    ...
    log:[
      ...
      {opp:"SAS",g:3,res:"L",pts:18,reb:4,ast:3,stl:1,blk:0,fgm:7,fga:15,tpm:2,tpa:6,min:39},
      {opp:"SAS",g:4,res:"W",pts:16,reb:5,ast:3,stl:2,blk:0,fgm:6,fga:13,tpm:2,tpa:5,min:40},
    ]},
  { name:"Josh Hart",       pos:"SG",jersey:3,
    ...
    log:[
      ...
      {opp:"SAS",g:3,res:"L",pts:8,reb:3,ast:5,stl:1,blk:0,fgm:3,fga:9,tpm:0,tpa:3,min:37},
      {opp:"SAS",g:4,res:"W",pts:12,reb:11,ast:7,stl:1,blk:0,fgm:5,fga:9,tpm:0,tpa:2,min:42},
    ]},
...
const SAS_PLAYERS = [
  { name:"V. Wembanyama",  pos:"C",jersey:1,
    ...
    log:[
      ...
      {opp:"NYK",g:3,res:"W",pts:32,reb:8,ast:6,stl:2,blk:3,fgm:12,fga:22,tpm:2,tpa:6,min:40},
      {opp:"NYK",g:4,res:"L",pts:24,reb:13,ast:4,stl:1,blk:3,fgm:9,fga:25,tpm:1,tpa:6,min:42},
    ]},
  { name:"Stephon Castle",  pos:"SG",jersey:5,
    ...
    log:[
      ...
      {opp:"NYK",g:3,res:"W",pts:23,reb:5,ast:5,stl:1,blk:0,fgm:9,fga:16,tpm:2,tpa:5,min:36},
      {opp:"NYK",g:4,res:"L",pts:14,reb:4,ast:4,stl:1,blk:0,fgm:5,fga:12,tpm:1,tpa:4,min:35},
    ]},
  { name:"De'Aaron Fox",    pos:"PG",jersey:4,
    ...
    log:[
      ...
      {opp:"NYK",g:3,res:"W",pts:19,reb:4,ast:6,stl:1,blk:0,fgm:8,fga:17,tpm:1,tpa:5,min:38},
      {opp:"NYK",g:4,res:"L",pts:18,reb:4,ast:6,stl:2,blk:0,fgm:7,fga:16,tpm:1,tpa:5,min:40},
    ]},
  { name:"Dylan Harper",    pos:"SG",jersey:2,
    ...
    log:[
      ...
      {opp:"NYK",g:4,res:"L",pts:21,reb:4,ast:3,stl:1,blk:0,fgm:8,fga:15,tpm:3,tpa:7,min:30},
    ]},
...
// ─── AI Analyzer Config ───────────────────────────────────────────────────────
const GAME_CONTEXT = {
  series:"2026 NBA Finals — NYK vs SAS. NYK LEADS 3-1. Game 4 was the LARGEST COMEBACK IN FINALS HISTORY — Knicks erased a 29-point deficit to win 107-106 on OG Anunoby's tip-in with 1.2s left. Game 5 is in San Antonio, where NYK can clinch its first championship since 1973. SAS must win to force Game 6 back in New York.",
  nyk:{record:"53-29 RS, now 3-1 in Finals",playoffPPG:124.5,playoffOPPG:100.7,recentForm:"Lost G3 but stormed back from 29 down to steal G4 107-106 on OG Anunoby's buzzer tip-in. Up 3-1, one win from the title. Resilient, never-quit identity.",pace:97.2,fgp:50.9,tpp:35.5,tovPG:13.8},
  sas:{record:"62-20 RS, now 1-3 in Finals",playoffPPG:122.1,playoffOPPG:113.4,recentForm:"Won G3 big but blew a 29-point G4 lead to fall behind 1-3. Devastating collapse; now must win 3 straight starting at home in G5 to save the season. Harper (21), Fox & Vassell (18 each) led G4.",pace:98.1,fgp:45.9,tpp:38.1,tovPG:12.9},
  ...
  players:{
    ...
    "Stephon Castle":   {team:"SAS",pos:"SG",plyPPG:16.5,plyRPG:5.0, plyAPG:5.5,plyFGP:46.0,ply3PP:30.0,regPPG:16.7,trend:"Finals: BREAKOUT G3 — 23/5/5, youngest-ever duo with Wemby to each go 22+; rising fast"},
...
const PLAYER_VS_OPP = {
  ...
  "Karl-A. Towns":   { vsOppPPG:20.0, homeAvg:21.2, awayAvg:20.0, last3avg:21.0, restBoost:false, matchup:"FINALS: double-doubles G1-G2, 24/11 G3, but FOUL TROUBLE limited him in G4 (3 fouls, ~18 min, 7pts/7reb) — though he helped hold Wemby to 3-14 in the 2nd half. MOMENTUM NOTE: foul risk vs Wemby is the key variable; when he stays on the floor he's a strong PRA/rebound play, but minutes are the wild card." },
  "OG Anunoby":      { vsOppPPG:13.5, homeAvg:13.0, awayAvg:13.5, last3avg:13.0, restBoost:true,  matchup:"FINALS: 12 G1, 11 G2, 16 G3, and the G4 HERO — game-winning tip-in at 1.2s plus a clutch corner three. Locks up Vassell defensively. MOMENTUM NOTE: ice-cold clutch gene, scoring ticking up; STL + points props live, riding sky-high confidence into G5." },
  ...
  "Josh Hart":       { vsOppPPG:12.0, homeAvg:11.0, awayAvg:13.5, last3avg:11.7, restBoost:false, matchup:"FINALS: 15reb G1, 10reb G2 with 6 AST both, but a quiet 8pts/3reb in the G3 loss. MOMENTUM NOTE: scoring dipped sharply G3 — rebounds/assists remain the safer angle than points. Still a PRA/REB+AST combo piece, but the points prop cooled." },
  "Stephon Castle":  { vsOppPPG:16.5, homeAvg:18.0, awayAvg:16.5, last3avg:18.0, restBoost:false, matchup:"FINALS: BREAKOUT 23/5/5 in the G3 win — looked fearless, attacked NYK guards downhill all night. MOMENTUM NOTE: trending up hard as SAS's #2 option behind Wemby. Scoring + assist props now live; the rookie has arrived on the big stage." },
  "V. Wembanyama":   { vsOppPPG:28.5, homeAvg:29.0, awayAvg:27.5, last3avg:28.0, restBoost:true,  matchup:"FINALS: 26 G1, 29 G2, monster 32/8/6/3blk G3, but FADED in the G4 collapse (held to 3-14 shooting in the 2nd half as NYK swarmed him). MOMENTUM NOTE: still the engine and elite blocks prop, but NYK's defense and Towns' physicality have a counter. Back home in SA for a must-win — expect a heavy workload." },
...
function buildPredictionPrompt(playerName){
  ...
  const gNum=5;
  const home="SAS (San Antonio) — Frost Bank Center";
...
function useCountdown() {
  ...
  useEffect(()=>{
    const target=new Date("2026-06-14T00:30:00Z");
...
const FINALS_GAMES=[
  ...
  {game:3,date:"Jun 8", time:"8:30 PM ET",home:"NYK",away:"SAS",status:"final", nykScore:111, sasScore:115, seriesNote:"NYK leads 2-1", network:"ABC", awaySeed:2,homeSeed:3},
  {game:4,date:"Jun 10",time:"8:30 PM ET",home:"NYK",away:"SAS",status:"final", nykScore:107, sasScore:106, seriesNote:"NYK leads 3-1", network:"ABC",awaySeed:2,homeSeed:3},
  {game:5,date:"Jun 13",time:"8:30 PM ET",home:"SAS",away:"NYK",status:"next",network:"ABC",awaySeed:3,homeSeed:2},
  ...
  return(
    <div>
      <div style={{borderRadius:14,background:"linear-gradient(135deg,rgba(212,168,67,0.12),rgba(8,12,24,0))",border:"1px solid rgba(212,168,67,0.3)",padding:"16px",marginBottom:14}}>
        ...
        <div style={{marginTop:12,textAlign:"center",fontSize:10,color:C.dim,fontFamily:"monospace"}}>Game 5 · Sat Jun 13 · 8:30 PM ET · Frost Bank Center, San Antonio</div>
      </div>
    ...
    <div style={{borderRadius:10,background:C.card,border:`1px solid ${open?`${accent}55`:"rgba(255,255,255,0.05)"}`,marginBottom:6,overflow:"hidden"}}>
      ...
      {open&&(
        <div style={{padding:"0 12px 12px",borderTop:"1px solid rgba(255,255,255,0.05)"}}>
          ...
          {hasPredData?(<>
          <div style={{marginTop:8,fontSize:8,color:C.gold,fontFamily:"monospace",letterSpacing:2,textTransform:"uppercase",fontWeight:700}}>🔮 Projected · Game 5</div>
...
function PicksTab(){
  ...
  const[gameNum,setGameNum]=useState(5);
...
Key matchup: ${GAME_CONTEXT.keyMatchup}
Injuries: ${GAME_CONTEXT.injuries}
Schedule: Game 1 Jun 3 @SAS (FINAL: NYK won 105-95), Game 2 Jun 5 @SAS (FINAL: NYK won 105-104), Game 3 Jun 8 @NYK (FINAL: SAS won 115-111), Game 4 Jun 10 @NYK (FINAL: NYK won 107-106 — LARGEST COMEBACK IN FINALS HISTORY, down 29, won on OG Anunoby tip-in at 1.2s), Game 5 Jun 13 @SAS (UPCOMING — the next game, in San Antonio), then 6-7 if needed.
Series status: NYK LEADS 3-1 and can clinch its first title since 1973 in Game 5. The Knicks erased a 29-point deficit in G4 (OG Anunoby game-winning tip-in). Spurs (Harper 21, Fox 18, Vassell 18 in G4) must win in San Antonio to force Game 6. Game 5 is in San Antonio — NYK going for the championship on the road.
...
export default function NBAFinalsHub(){
  ...
  const[nykWins]=useState(3);
  const[sasWins]=useState(1);
