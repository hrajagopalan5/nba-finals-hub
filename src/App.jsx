...
// ─── Static Data ──────────────────────────────────────────────────────────────
const SCHEDULE = [
  {game:1,date:"Wed, Jun 4", time:"8:30 PM ET",home:"SAS",away:"NYK",status:"final",      network:"ABC"},
  {game:2,date:"Fri, Jun 6", time:"8:30 PM ET",home:"SAS",away:"NYK",status:"next",  network:"ABC"},
...
Project realistic numbers for EVERY bettable stat. For each, give your projected value AND a suggested over/under line a sportsbook might set, plus a lean (over/under/pass) and brief confidence. Factor in the matchup, defense, home/away, recent form, pace, and foul/blowout risk.
...
const FINALS_GAMES=[
  {game:1,date:"Jun 4", time:"8:30 PM ET",home:"SAS",away:"NYK",status:"final", nykScore:105, sasScore:95, seriesNote:"NYK leads 1-0", network:"ABC", awaySeed:3,homeSeed:2},
  {game:2,date:"Jun 6", time:"8:30 PM ET",home:"SAS",away:"NYK",status:"next",       network:"ABC", awaySeed:3,homeSeed:2},
    ...
    <div style={{borderRadius:10,background:C.card,border:`1px solid ${open?`${accent}55`:"rgba(255,255,255,0.05)"}`,marginBottom:6,overflow:"hidden"}}>
      ...
      {open&&(
        <div style={{padding:"0 12px 12px",borderTop:"1px solid rgba(255,255,255,0.05)"}}>
          ...
          {hasPredData?(<>
          <div style={{marginTop:8,fontSize:8,color:C.gold,fontFamily:"monospace",letterSpacing:2,textTransform:"uppercase",fontWeight:700}}>🔮 Projected · Game 2</div>
...
Key matchup: ${GAME_CONTEXT.keyMatchup}
Injuries: ${GAME_CONTEXT.injuries}
Schedule: Game 1 Jun 4 @SAS (FINAL: NYK won 105-95, NYK leads series 1-0), Game 2 Jun 6 @SAS (UPCOMING — the next game), G3 Jun 9 @NYK, G4 Jun 11 @NYK, then 5-7 if needed.
Series status: NYK leads 1-0. Game 2 is the next game, still in San Antonio.
